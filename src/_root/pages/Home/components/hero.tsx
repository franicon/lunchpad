export const Hero = () => {
  return (
    <section className="hero px-4 lg:px-24 h-screen relative pb-12 text-center lg:text-left">
      <div className="flex flex-col lg:flex-row gap-12 items-center h-full justify-center">
        ...
        <div className="basis-5/12 order-first lg:order-last">
          <img src="/images/hero-img.svg" alt="" className="lg:ml-auto scale-125 lg:scale-150 relative -left-14 lg:-left-0 top-12" />
