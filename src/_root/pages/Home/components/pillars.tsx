  ...
  return (
    <section className="p-4 py-12 lg:p-24 bg-[radial-gradient(rgba(0,80,250,20%),transparent,transparent),url(/images/pattern.png)]">
      <div className="flex flex-col lg:gap-y-24 gap-y-16">
        ...
        <div className="content md:w-10/12 mx-auto flex flex-col gap-y-32">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              <img src="/images/membership.png" alt="membership" className="w-6/12 md:w-auto mx-auto" />
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="order-first md:order-last">
              <img
                ...
                alt="blockchain"
                className="w-4/12 md:w-auto md:ml-auto mx-auto "
              />
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              <img src="/images/venture.png" alt="venture" className="w-6/12 md:w-auto mx-auto" />
            </div>
            <div className="flex flex-col gap-y-4">
              <h2 className="capitalize relative text-xl md:text-3xl">
